...
public class ZipUtils {
    ...
    public static String gzip(String value) {
        ...
        return new String(Base64.getDecoder().decode(out.toByteArray()));
    }
    ...
    public static String ungzip(String value) {
        ...
        try {
            compressed = Base64.getDecoder().decode(out.toByteArray());
    ...
    public static final String zip(String value) {
        ...
        try {
            ...
            compressedStr = new String(Base64.getDecoder().decode(out.toByteArray()));
        } catch (IOException e) {
            log.error(e.getMessage(), e);
        } finally {
            if (zout != null) {
    ...
    public static final String unzip(String value) {
        ...
        String decompressed = null;
        try {
            byte[] compressed = Base64.getDecoder().decode(out.toByteArray());
            out = new ByteArrayOutputStream();
            in = new ByteArrayInputStream(compressed);
