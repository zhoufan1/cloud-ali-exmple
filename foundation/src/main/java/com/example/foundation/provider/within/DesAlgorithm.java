package com.example.foundation.provider.within;

import com.alibaba.fastjson.util.IOUtils;
import com.example.foundation.utils.EncryptUtils;
...
public final class DesAlgorithm {
    ...
    public static final DesAlgorithm ALG = create("?={!@#$%^&*}");
    ...
    public String encrypt(String strIn){
        try {
            return EncryptUtils.toHex(encrypt(strIn.getBytes(IOUtils.UTF8.name())));
        } catch (Exception e){
